" Response to for Steady Wind with Different Gamma Values "
...
winds = ['_wind_above_rated', '_wind_above_rated', '_wind_above_rated', '_wind_above_rated']
colors = ['b', 'g', 'r', 'm']
...
fig_response, ax18 = plt.subplots(4,2, sharex='col') 


# ============================================================================
# Get the Responses for the four different Gamma values
# ============================================================================
for i in range(len(winds)):
    ...
    fig_response = makeplots(wind, waves, SparBuoyData, response, timeInfo, colors[i], ax=ax18)

    # Print the standard deviations and means
    print(f"\nResponse to Gamma {labels[i]} m/s")
...
fig_response[0,0].legend(labels, fontsize=7)        
fig_response[0,0].figure.savefig(get_output_figure(f"Different_Gammas.pdf"))
