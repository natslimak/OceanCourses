...
winds = [9,11,14,18]
colors = ['b', 'g', 'r', 'm']
labels = [f'V_10={g}' for g in winds]
...
# ============================================================================
# Get the Responses for the four different V10
# ============================================================================
for i in range(len(winds)):

    # Load the wind conditions
    wind = loadFromJSON(get_input_file('_wind_above_rated.json'))
    wind['V_10']=winds[i]
...
fig_response[0,0].figure.savefig(get_output_figure(f"Different_V10.pdf"))
