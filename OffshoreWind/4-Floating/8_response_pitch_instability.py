" Response to Pitch Instability with Different Gamma Values "
...
winds = ['_wind_above_rated', '_wind_above_rated']
colors = ['b', 'g']
...
fig_response, ax = plt.subplots(4,2, sharex='col') 


# ============================================================================
# Get the Responses to two different gammas
# ============================================================================
for i in range(len(winds)):
    ...
    q0 = np.array([0, 0, 0, 0, 0])   # <-- include here on the 5th spot the CTE initial condition
    ...
    fig_response = makeplots(wind, waves, SparBuoyData, response, timeInfo, colors[i], ax=ax)
...
fig_response[0,0].figure.savefig(get_output_figure(f"Pitch_Instability.pdf"))
